...
{	
	...
	group.add(border_x_range.set("borderX", ofVec2f(-1000,1000), ofVec2f(-1000,-1000), ofVec3f(1000,1000)));
	group.add(border_y_range.set("borderY", ofVec2f(-1000,1000), ofVec2f(-1000,-1000), ofVec3f(1000,1000)));
	group.add(border_z_range.set("borderZ", ofVec2f(-1000,1000), ofVec2f(-1000,-1000), ofVec3f(1000,1000)));
